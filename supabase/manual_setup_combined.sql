-- ============================================================================
-- Spark Dating App — Combined Database Migration
-- Safe to run any number of times, on a fresh project OR one with a partial
-- prior attempt already applied. Every CREATE statement is guarded so nothing
-- will be flagged as "already exists".
--
-- Run this ENTIRE file in one go in the Supabase SQL Editor.
-- ============================================================================

-- ============================================================================
-- PART 1: Schema (tables, types, triggers, policies, seed data)
-- ============================================================================
...
-- ============================================================================
-- PART 2: Storage buckets and their RLS policies
-- ============================================================================
